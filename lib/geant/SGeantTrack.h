...
public:
    ...
    //     /// \param py py
    //     /// \param pz pz
    //     void setStartPxPyPz ( Float_t px, Float_t py, Float_t pz )
    //     {
    //         start.px = px;
    //         start.py = py;
    //         start.pz = pz;
    ...
    //     /// \return px
    //     Float_t getStartPx() const
    //     {
    //         return start.px;
    //     }
    //     /// Get start momentum y
    //     /// \return py
    //     Float_t getStartPy() const
    //     {
    //         return start.py;
    //     }
    //     /// Get start momentum z
    //     /// \return pz
    //     Float_t getStartPz() const
    //     {
    //         return start.pz;
    //     }
    ...
    //     void setStartE ( Float_t e )
    //     {
    //         start.E = e;
    //     }
    //     /// Get start energy
    //     /// \return energy
    //     Float_t getStartE() const
    //     {
    //         return start.E;
    //     }
    ...
    //     /// \param y y
    //     /// \param z z
    //     void setStopXYZ ( Float_t x, Float_t y, Float_t z )
    //     {
    //         stop.x = x;
    //         stop.y = y;
    //         stop.z = z;
    ...
    //     /// Get stop x
    //     /// \return x
    //     Float_t getStopX() const
    //     {
    //         return stop.x;
    //     }
    //     /// Get stop y
    //     /// \return y
    //     Float_t getStopY() const
    //     {
    //         return stop.y;
    //     }
    //     /// Get stop z
    //     /// \return z
    //     Float_t getStopZ() const
    //     {
    //         return stop.z;
    //     }
    ...
    //     /// \param py py
    //     /// \param pz pz
    //     void setStopPxPyPz ( Float_t px, Float_t py, Float_t pz )
    //     {
    //         stop.px = px;
    //         stop.py = py;
    //         stop.pz = pz;
    ...
    //     /// Get stop momentum x
    //     /// \return px
    //     Float_t getStopPx() const
    //     {
    //         return stop.px;
    //     }
    //     /// Get stop momentum y
    //     /// \return py
    //     Float_t getStopPy() const
    //     {
    //         return stop.py;
    //     }
    //     /// Get stop momentum z
    //     /// \return pz
    //     Float_t getStopPz() const
    //     {
    //         return stop.pz;
    //     }
    ...
    //     /// Set stop energy
    //     /// \param e stop energy
    //     void setStopE ( Float_t e )
    //     {
    //         stop.E = e;
    //     }
    //     /// Get stop energy
    //     /// \return energy
    //     Float_t getStopE() const
    //     {
    //         return stop.E;
    //     }
    ...
    //     /// Get scattering
    //     /// \return scatteringp
    //     Bool_t getScattering() const
    //     {
    //         return scattering;
    //     }
    //     /// Set scattering
    //     /// \param b scattering
    //     void setScattering ( Bool_t b )
    //     {
    //         scattering = b;
    //     }
    ...
    //     void setProcesses ( const std::vector<std::string> & v )
    //     {
    //         processes = v;
    //     }
    ...
    //     /// Get Geant4 ID
    //     /// \return Geant4 ID
    //     Long_t getG4Id() const
    //     {
    //         return g4Id;
    //     }
    //     /// Set Geant4 ID
    //     /// \param i Geant4 ID
    //     void setG4Id ( Long_t i )
    //     {
    //         g4Id = i;
    //     }
    ...
    //     /// \return success
    //     Bool_t getStopInDetector() const
    //     {
    //         return stopInDetector;
    //     }
    //     /// Set is stop in the detector
    //     /// \param b is stop
    //     void setStopInDetector ( Bool_t b )
    //     {
    //         stopInDetector = b;
    //     }
    ...
    //     std::string getGenerationProcess() const
    //     {
    //         return generationProcess;
    //     }
    //     /// Set generation process
    //     /// \param p generation process
    //     void setGenerationProcess ( const std::string & p )
    //     {
    //         generationProcess = p;
    //     }
    ...
    //     /// \return success
    //     Bool_t getInAcceptance() const
    //     {
    //         return inAcceptance;
    //     }
    //     /// Set is in acceptance
    //     /// \param b in acceptance
    //     void setInAcceptance ( Bool_t b )
    //     {
    //         inAcceptance = b;
    //     }
    //
    ...
    //     /// \param p process
    //     /// \return success
    //     Bool_t testProcess ( Process p ) const
    //     {
    //         return proc_arr[p];
    //     }
    //     /// Test process Compton
    //     /// \return success
    //     Bool_t isProcessCompton() const
    //     {
    //         return proc_arr[COMPTON];
    //     }
    //     /// Test process Inelastic
    //     /// \return success
    //     Bool_t isProcessInelastic() const
    //     {
    //         return proc_arr[INELASTIC];
    //     }
    //     /// Test process At Rest
    //     /// \return success
    //     Bool_t isProcessAtRest() const
    //     {
