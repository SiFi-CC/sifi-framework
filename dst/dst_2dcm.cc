...
int main(int argc, char** argv)
{
    ...
    // As of 14.07.2026 the pixel detector has 24 layers, 96 needles per layer.
    ...
    detm->addDetector(new SFibersDetector("Fibers", 1, 24, 96));
    ...
    pm()->addLookupContainer("9to1SiPMtoFibersLookupTable", std::make_unique<SMultiFibersLookupTable>("9to1SiPMtoFibersLookupTable", 0x1000, 0x1fff, 20000));
